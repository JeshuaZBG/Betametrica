---
title: "Mi primer reporte usando RMarkdown"
author: "Econ. Félix Casares. MSR"
date: "2/12/2019"
output:
  html_document:
    df_print: paged
...
```{r librerias, echo=TRUE,message=FALSE,warning=FALSE,comment=""}
...
datos <- read.xlsx("F://BETAMETRICA/CURSOS/VIRTUALES/AUTOMATIZACION DE REPORTES/importacionesperu.xlsx",sheet = "Mensuales",detectDates = T)

datos$periodo <-seq(as.Date("2014/08/01"),as.Date("2019/05/01"),
                    by="month") 
...
```{r graficolinea, echo=TRUE,message=FALSE,warning=FALSE,comment="",fig.width=16,fig.height=8,fig.align='center'}
...
dygraph(tsdatos,main="Evolución de las Importaciones de Perú",
        xlab="Periodo",ylab="millones de soles")%>%
...
```{r otrascosas, echo=TRUE,message=FALSE,warning=FALSE,comment="",fig.width=8,fig.height=8,fig.align='center',results='asis'}
